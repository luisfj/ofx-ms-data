...
public class GrupoService {
      ...
      public Mono<List<OperacoesDTO>> findByIdImportacao(Long idUser, Long idUe, LocalDate dtInicial,
                  LocalDate dtFinal) {
            return asyncRepository
                        .findGruposByIdImportacaoAndDataBetween(idUser, idUe, dtInicial, dtFinal)
                        .collectList()
      ...
      public NovoGrupoResponseDTO adicionarGrupo(Long idUser, Long idUe, NovoGrupoDTO novoGrupoDTO) {
            var grupo = OperacaoMapper.INSTANCE.dtoToEntity(novoGrupoDTO);

            grupo.setIdUe(idUe);
            grupo.setIdUser(idUser);
      ...
      public NovoGrupoResponseDTO atualizarGrupo(Long idUser, Long idUe, Long idGrupo, NovoGrupoDTO novoGrupoDTO) {
            var grupo = repository.findByIdAndIdUserAndIdUe(idGrupo, idUser, idUe)
      ...
      public void excluirGrupoDefinitivamente(Long idUser, Long idUe, Long idGrupo) {
            var grupoEntity = repository.findByIdAndIdUserAndIdUe(idGrupo, idUser, idUe)
                        .orElseThrow(() -> new RuntimeException(
                                    "Nenhum grupo com este id para o usuário e ue encontrado"));
